...
"""
test = subprocess.Popen(["gphoto2", "--capture-image-and-download"' "--filename", "%03n%Y%m%d%H%M%S.jpg"], stdout=subprocess.PIPE)
...
#imageCommand = ["gphoto2 -I "+ delayDuration +" -F "+ numPictures +" --capture-image-and-download --filename %03n%Y%m%d%H%M%S.jpg"]
imageCommand = "gphoto2 -I 1 -F 1 --capture-image-and-download --filename %Y%m%d%H%M%S.jpg"
...
def captureImages():
    gp("gphoto2 -I 1 -F 1 --capture-image-and-download --filename %03n%Y%m%d%H%M%S.jpg")
